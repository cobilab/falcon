# This script downloads all fungi genomes in RefSeq and puts them in fungi.fa
# Script is taken from: http://www.ncbi.nlm.nih.gov/books/NBK25498/#chapter3.Application_3_Retrieving_large 
# BY INTERFACE NCBI: http://www.ncbi.nlm.nih.gov/nuccore?term=%22fungi%22[PORG]+AND+srcdb_refseq[PROP] , then sent to file: fasta.
